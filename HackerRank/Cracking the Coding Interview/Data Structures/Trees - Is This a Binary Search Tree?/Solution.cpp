...
Check out the resources on the page's right side to learn more about binary search trees. 
...
Complete the function checkBST in the editor below. It must return a boolean denoting whether or not 
